...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BubbleShowCase/BubbleShowCase.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DividerView/DividerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ImagePickerWhatsApp/ImagePickerWhatsApp.framework"
