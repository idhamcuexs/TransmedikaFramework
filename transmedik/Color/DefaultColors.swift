...
class DefaultColors {
    ...
    var secondaryBackgorundColor : UIColor
    var buttonBackgroundColor : UIColor
    var buttonTextColor : UIColor
    var clickLabelTextColor : UIColor
    var backButtonColor : UIColor
    var textFieldTintColor : UIColor
    var tabBarTintColor : UIColor
    var messageBarBackgroundColor : UIColor
    var placeholderTextColor : UIColor
    var buttonActiveColor : UIColor
    var buttonInactiveColor : UIColor
    var chatTextColor : UIColor
    var chatTextColor2 : UIColor
    var chatBackgroundColor : UIColor
    var chatBorderColor : UIColor
    var chatBackgroundColor2 : UIColor
    var chatBorderColor2 : UIColor
    var chatBorderColorFailed : UIColor
    var chatBorderColorSent : UIColor
    var chatBorderColorDelivered : UIColor
    var chatBorderColorRead : UIColor
    var buttonInactiveTintColor : UIColor
    var tabBarUnselectedTabColor : UIColor
    var chatSystemTextColor : UIColor
