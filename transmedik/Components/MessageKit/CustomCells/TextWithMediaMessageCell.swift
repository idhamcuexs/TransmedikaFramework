...
open class TextWithMediaMessageCell: MessageContentCell {
    ...
    open var textLabel = MessageLabel()
    ...
    open override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        ...
        if let attributes = layoutAttributes as? MessagesCollectionViewLayoutAttributes {
            textLabel.textInsets = attributes.messageLabelInsets
            stackView.frame = messageContainerView.bounds
        }
    }
        ...
        case .photo(let mediaItem):
            ...
            if let photoItem = mediaItem as? ImageMediaItem {
                if (photoItem.image != nil) {
                    ...
                    /*imageView.layer.frame = CGRect(x: 0, y: 0, width: maxWidth, height: maxWidth)
                    imageView.animationImages = photoItem.images!
                    imageView.animationDuration = 5.0
                    imageView.startAnimating()*/
                }
                else if (photoItem.thumbnailUrls != nil && photoItem.thumbnailUrls!.count > 0) {
                    DispatchQueue.main.async {
                ...
                textLabel.configure {
                    ...
                    textLabel.attributedText = photoItem.attributedText
                }
            }
            break
        case .video(let mediaItem):
            if let videoItem = mediaItem as? VideoMediaItem {
                ...
                textLabel.configure {
                    ...
                    textLabel.attributedText = videoItem.attributedText
                }
            }
            else {
    ...
    internal func addImagesToImageView(_ photoItem: ImageMediaItem) {
    ...
    internal func addUrlsToImageView(_ photoItem: ImageMediaItem) {
    ...
    open override func cellContentView(canHandle touchPoint: CGPoint) -> Bool {
        return textLabel.handleGesture(touchPoint)
    }
